...
export const MUSIC: { duck: number; duckRampFrames: number; slots: MusicSlot[] } = {
  ...
  slots: [
    ...
    { id: "courtroom", description: "Minimal tension under the commission hearing", from: { scene: "defence" }, to: { scene: "defence", edge: "end" }, volume: 0.4, fadeIn: 2, fadeOut: 2 },
...
export const SFX: SfxCue[] = [
  ...
  { sound: "room-tone", at: { scene: "coldOpen" }, volume: 0.35 },
  ...
  { sound: "city", at: { scene: "phayre", cue: "gaekwad", offset: -0.6 }, volume: 0.28 },
  ...
  { sound: "palace", at: { scene: "accusation", cue: "household", offset: -0.5 }, volume: 0.3 },
  { sound: "courtroom", at: { scene: "defence" }, volume: 0.3 },
